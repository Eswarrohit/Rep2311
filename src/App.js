   ...
   <div className="App">
    ...
    <div className="App">
      ...
      <div>
        ...
        vehicles, now used especially for tourists. Passenger carts are
...
The earliest historical evidence of boats is found in Egypt during the 4th millennium BCE.
      ...
      <div className='Image'>
        ...
        <table>
          <tr>
          <th>Tonnage</th>
          <td>Greater than 500 DWT</td>
          </tr>
          <tr>
          <th>Propulsion</th>
          <td>steam turbine (fossil fuel, nuclear), diesel, gas turbine, sterling, steam (reciprocating)</td>
          </tr>
          <tr>
          <th>Sail plan</th>
          <td>For sailing ships – two or more masts,[citation needed] variety of sail plans.</td>
          </tr>
        </table>
         </div>
      ...
      <div className='divp'>
         <p>Ships are typically larger than boats, but there is no universally accepted distinction between the two. Ships generally can remain at sea for longer periods of time than boats. A legal definition of ship from Indian case law is a vessel that carries goods by sea. A common notion is that a ship can carry a boat, but not vice versa. A ship is likely to have a full-time crew assigned. A US Navy rule of thumb is that ships heel towards the outside of a sharp turn, whereas boats heel towards the inside because of the relative location of the center of mass versus the center of buoyancy. American and British 19th century maritime law distinguished "vessels" from other watercraft; ships and boats fall in one legal category, whereas open boats and rafts are not considered vessels.
          Particularly in the Age of Sail, the word ship might apply generally to a seagoing vessel or particularly to a full-rigged sailing ship with three or more masts, all square-rigged. Other rigs on seagoing vessels included brig, barque, and barquentine
          </p></div>
          <div className='Image'>
...
<p>Several civilizations became sea powers. Such examples include the maritime republics of Genoa and Venice, Hanseatic League, and the Byzantine navy. The Vikings used their knarrs to explore North America, trade in the Baltic Sea and plunder many of the coastal regions of Western Europe.</p>
 <p>Towards the end of the 14th century, ships like the carrack began to develop towers on the bow and stern. These towers decreased the vessel's stability, and in the 15th century, the caravel, designed by the Portuguese, based on the Arabic qarib[citation needed] which could sail closer to the wind, became more widely used. The towers were gradually replaced by the forecastle and sterncastle, as in the carrack Santa María of Christopher Columbus. This increased freeboard allowed another innovation: the freeing port, and the artillery associated with it.</p>   
  ...
  <br></br>
  <hr></hr>
  <h2>Specialization and modernization</h2>
  <br></br>
  <div className='divp'>
    ...
    <p>During the 19th century the Royal Navy enforced a ban on the slave trade, acted to suppress piracy, and continued to map the world. A clipper was a very fast sailing ship of the 19th century. The clipper routes fell into commercial disuse with the introduction of steam ships with better fuel efficiency, and the opening of the Suez and Panama Canals.</p>
  ...
  <div className='Image' >
    <img src='./images/Ship11.jpg' width="100%" height='220px'></img>
    <ul>Painting of the Battle of Trafalgar by Auguste Mayer.</ul>
    <img src='./images/Ship12.jpg' width="100%" height='220px'></img>
