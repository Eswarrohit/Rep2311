...
<div className='divp'>    
 <p>
  <b> <ins> A ship is a large vessel that travels the world's oceans and other navigable waterways, carrying cargo or passengers, or in support of specialized missions, such as defense, research and fishing.</ins></b>Ships are generally distinguished from boats, based on size, shape, load capacity and purpose. Ships have supported exploration, trade, warfare, migration, colonization, and science. Ship transport is responsible for the largest portion of world commerce.The word ship has meant, depending on the era and the context, either just a large vessel or specifically a ship-rigged sailing ship with three or more masts, each of which is square-rigged.
<ins>As of 2016, there were more than 49,000 merchant ships, totaling almost 1.8 billion deadweight tons. Of these 28% were oil tankers, 43% were bulk carriers, and 13% were container ships.
</ins>The earliest historical evidence of boats is found in Egypt during the 4th millennium BCE.
</p></div>
      ...
      <div className='ShipImage'>
        ...
        <table className='td'>
          ...
          <td className='td'>steam turbine (fossil fuel, nuclear), diesel, gas turbine, sterling, steam (reciprocating)</td>
          </tr>
          <tr>
          <th className='td'>Sail plan</th>
          <td className='td'>For sailing ships – two or more masts,[citation needed] variety of sail plans.</td>
          </tr>
        </table>
         </div>
      ...
      <h1 className='Heading1'>Nomenclature</h1>
        <hr></hr>
      <div className='divp'>
         <p>Ships are typically larger than boats, but there is no universally accepted distinction between the two. Ships generally can remain at sea for longer periods of time than boats. A legal definition of ship from Indian case law is a vessel that carries goods by sea. A common notion is that a ship can carry a boat, but not vice versa. A ship is likely to have a full-time crew assigned. A US Navy rule of thumb is that ships heel towards the outside of a sharp turn, whereas boats heel towards the inside because of the relative location of the center of mass versus the center of buoyancy.
<b><ins>American and British 19th century maritime law distinguished "vessels" from other watercraft; ships and boats fall in one legal category, whereas open boats and rafts are not considered vessels.
</ins></b>Particularly in the Age of Sail, the word ship might apply generally to a seagoing vessel or particularly to a full-rigged sailing ship with three or more masts, all square-rigged. Other rigs on seagoing vessels included brig, barque, and barquentine
          </p></div>
          <div className='ShipImage'>
            <img src='./images/Ship1.png' width="100%"></img>
            <h5>Main parts of ship. 1:  <ins>Funnel</ins>; 2: <ins>Stern</ins>; 3: <ins>Propeller and Rudder</ins>; 4: <ins>Portside</ins> (the right side is known as starboard); 5: <ins>Anchor</ins>; 6: <ins>Bulbous bow</ins>; 7: <ins>Bow</ins>; 8: <ins>Deck</ins>; 9: <ins>Superstructure</ins></h5>
           </div>
...
<ins>For most of history, transport by ship – provided there is a feasible route – has generally been cheaper, safer and faster than making the same journey on land. Only the coming of railways in the middle of the 19th century and the growth of commercial aviation in the second half of the 20th century have changed this principle. This applied equally to sea crossings, coastal voyages and use of rivers and lakes.
       ...
       <p>The earliest attestations of ships in maritime transport in Mesopotamia are model ships, which date back to the 4th millennium BC.
<b><ins>In archaic texts in Uruk, Sumer, the ideogram for "ship" is attested, but in the inscriptions of the kings of Lagash, ships were first mentioned in connection to maritime trade and naval warfare at around 2500–2350 BCE.
</ins></b><br></br>Austronesian peoples originated in what is now Taiwan. From here, they took part in the Austronesian Expansion. Their distinctive maritime technology was integral to this movement and included catamarans and outriggers. It has been deduced that they had sails some time before 2000 BCE. Their crab claw sails enabled them to sail for vast distances in open ocean. From Taiwan, they rapidly colonized the islands of Maritime Southeast Asia, then sailed further onwards to Micronesia, Island Melanesia, Polynesia, and Madagascar, eventually colonizing a territory spanning half the globe. 
          <br></br>Austronesian peoples originated in what is now Taiwan. From here, they took part in the Austronesian Expansion. Their distinctive maritime technology was integral to this movement and included catamarans and outriggers. It has been deduced that they had sails some time before 2000 BCE. Their crab claw sails enabled them to sail for vast distances in open ocean. From Taiwan, they rapidly colonized the islands of Maritime Southeast Asia, then sailed further onwards to Micronesia, Island Melanesia, Polynesia, and Madagascar, eventually colonizing a territory spanning half the globe.
          <br></br>Early Austronesian sailors influenced the development of sailing technologies in Sri Lanka and Southern India through the Austronesian maritime trade network of the Indian Ocean, the precursor to the spice trade route and the maritime silk road, which was established at around 1500 BC. The junk rigs of Chinese ships is also believed to be developed from tilted sails
        </p></div>
      <div className='ShipImage'>
       ...
       <p><b><ins>In the 2nd century AD, people from the Indonesian archipelago already made large ships measuring over 50 m long and standing 4–7 m out of the water. They could carry 600–1000 people and 250–1000 ton cargo. These ships were known as kunlun bo or k'unlun po (崑崙舶, lit. "ship of the Kunlun people") by the Chinese, and kolandiaphonta by the Greeks. 
</ins></b>They had 4–7 masts and were able to sail against the wind due to the usage of tanja sails. These ships may have reached as far as Ghana In the 11th century, a new type of ship called djong or jong was recorded in Java and Bali.This type of ship was built using wooden dowels and treenails, unlike the kunlun bo which used vegetal fibres for lashings.
          <br></br>In China, miniature models of ships that feature steering oars have been dated to the Warring States period (c. 475–221 BC) By the Han dynasty, a well kept naval fleet was an integral part of the military. Sternpost-mounted rudders started to appear on Chinese ship models starting in the 1st century AD. However, these early Chinese ships were fluvial (riverine), and were not seaworthy. The Chinese only acquired sea-going ship technologies in the 10th century AD Song Dynasty after contact with Southeast Asian k'un-lun po trading ships, leading to the development of the junks.
        </p>
     </div>
     <br></br>
     <hr></hr>
     ...
     <div className='divp'>
      <p>
        <ins>The earliest historical evidence of boats is found in Egypt during the 4th millennium BCE  The Greek historian and geographer Agatharchides had documented ship-faring among the early Egyptians: 
</ins><b>"During the prosperous period of the Old Kingdom, between the 30th and 25th centuries BC, the river-routes were kept in order, and Egyptian ships sailed the Red Sea as far as the myrrh-country."</b>Sneferu's ancient cedar wood ship Praise of the Two Lands is the first reference recorded (2613 BC) to a ship being referred to by name.
        <br></br>The ancient Egyptians were perfectly at ease building sailboats. A remarkable example of their shipbuilding skills was the Khufu ship, a vessel 143 feet (44 m) in length entombed at the foot of the Great Pyramid of Giza around 2500 BC and found intact in 1954.
        <br></br>The oldest discovered sea faring hulled boat is the Late Bronze Age Uluburun shipwreck off the coast of Turkey, dating back to 1300 BC.
        <br></br>By 1200 B.C., the Phoenicians were building large merchant ships. In world maritime history, declares Richard Woodman, they are recognized as "the first true seafarers, founding the art of pilotage, cabotage, and navigation" and the architects of "the first true ship, built of planks, capable of carrying a deadweight cargo and being sailed and steered.
      </p>
      </div>
      <div className='ShipImage'>
      ...
      <h3 className='Heading1'>Asian developments</h3>
      <div className='divp'>
        <p>At this time, ships were developing in Asia in much the same way as Europe.[according to whom?] Japan used defensive naval techniques in the Mongol invasions of Japan in 1281. It is likely that the Mongols of the time took advantage of both European and Asian shipbuilding techniques.[according to whom?] 
<ins><b>During the 15th century, China's Ming dynasty assembled one of the largest and most powerful naval fleets in the world for the diplomatic and power projection voyages of Zheng He. Elsewhere in Japan in the 15th century, one of the world's first iron-clads, "Tekkōsen" (鉄甲船), literally meaning "iron ships",[42] was also developed. In Japan, during the Sengoku era from the 15th century to 17th century, the great struggle for feudal supremacy was fought, in part, by coastal fleets of several hundred boats, including the atakebune. In Korea, in the early 15th century during the Joseon era, "Geobukseon"(거북선), was developed.
</b></ins>          
        </p>
      </div>
      <div className='ShipImage'>
      ...
      <p>The empire of Majapahit used large ships called jong, built in northern Java, for transporting troops overseas. The jongs were transport ships which could carry 100–2000 tons of cargo and 50–1000 people, 28.99–88.56 meter in length.The exact number of jong fielded by Majapahit is unknown, but the largest number of jong deployed in an expedition is about 400 jongs, when Majapahit attacked Pasai, in 1350.
</p>
<br></br>
<hr></hr>
<h3 className='Heading1'>European developments</h3>
    <div className='divp'>
<p>Several civilizations became sea powers. Such examples include the maritime republics of Genoa and Venice, Hanseatic League, and the Byzantine navy. The Vikings used their knarrs to explore North America, trade in the Baltic Sea and plunder many of the coastal regions of Western Europe.</p>
 <p><ins>Towards the end of the 14th century,</ins> ships like the carrack began to develop towers on the bow and stern. These towers decreased the vessel's stability, and in the 15th century, the caravel, designed by the Portuguese, based on the Arabic qarib[citation needed] which could sail closer to the wind, became more widely used. The towers were gradually replaced by the forecastle and sterncastle, as in the carrack Santa María of Christopher Columbus. This increased freeboard allowed another innovation: the freeing port, and the artillery associated with it.</p>   
  </div>
  <div className='ShipImage'>
  ...
  <br></br>
  <div className='divp'>
    <p>Parallel to the development of warships, ships in service of marine fishery and trade also developed in the period between antiquity and the Renaissance</p>
    <p>Maritime trade was driven by the development of shipping companies with significant financial resources. Canal barges, towed by draft animals on an adjacent towpath, contended with the railway up to and past the early days of the industrial revolution. Flat-bottomed and flexible scow boats also became widely used for transporting small cargoes. Mercantile trade went hand-in-hand with exploration, self-financed by the commercial benefits of exploration</p>
    <p>During the first half of the 18th century, the French Navy began to develop a new type of vessel known as a ship of the line, featuring seventy-four guns. This type of ship became the backbone of all European fighting fleets. These ships were 56 metres (184 ft) long and their construction required 2,800 oak trees and 40 kilometres (25 mi) of rope; they carried a crew of about 800 sailors and soldiers.</p>
    <p><b>During the 19th century the Royal Navy enforced a ban on the slave trade, acted to suppress piracy, and continued to map the world. A clipper was a very fast sailing ship of the 19th century. The clipper routes fell into commercial disuse with the introduction of steam ships with better fuel efficiency, and the opening of the Suez and Panama Canals.
</b></p>
 <p>Ship designs stayed fairly unchanged until the late 19th century. The industrial revolution, new mechanical methods of propulsion, and the ability to construct ships from metal triggered an explosion in ship design. Factors including the quest for more efficient ships, the end of long running and wasteful maritime conflicts, and the increased financial capacity of industrial powers created an avalanche of more specialized boats and ships. Ships built for entirely new functions, such as firefighting, rescue, and research, also began to appear.</p>
 </div>
  <div className='ShipImage' >
